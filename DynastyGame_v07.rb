...
puts " into desolation under its prior dynasty which had grown decadent\n"
puts " and lathargic. You have conquered Centralia and set about to restore\n"
puts " the kingdom to its former glory. \n"
puts " \n"
puts " As ruler, you can develop your dynasty and invest in economic \n"
puts " production, build up its military, or engage in conquest.\n"
puts " \n"
...
puts " in Administrative Mode. \n"
puts "\n"
puts " Enter indicated letter to make desired selections. \n"
puts "\n"
...
# INITIALIZE PARAMETERS
  ...
  conquest = 0.0
  dynastyage = 0
  taxrate = 0.25 # 0.1 might be more realistic, but makes for a slow game.
  saving = 0.0
  overhead = 0.0 # for later
  efficiency = 1.0 # for later
  conquestrisk = 1.0
...
while (action != "x") and (production >= 1.0) and (military >= 1.0) do
  ...
  puts sprintf ecefdisplay, taxrate.to_s
